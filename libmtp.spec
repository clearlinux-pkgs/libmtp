...
Source0  : https://sourceforge.net/projects/libmtp/files/libmtp/1.1.21/libmtp-1.1.21.tar.gz
Source1  : https://sourceforge.net/projects/libmtp/files/libmtp/1.1.21/libmtp-1.1.21.tar.gz.asc
...
%prep
%setup -q -n libmtp-1.1.21
cd %{_builddir}/libmtp-1.1.21
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699999277
